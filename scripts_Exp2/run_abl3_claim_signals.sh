#!/usr/bin/env bash
# scripts_Exp2/run_abl3_claim_signals.sh
# Ablation 3: BasePack + claim_summary + supporting_signals + refuting_signals
# Run from project root: bash scripts_Exp2/run_abl3_claim_signals.sh
...
ABL_NAME="abl3_claim_signals"
ABL_MODE="claim_signals"
...
echo "  fields     : claim_summary + supporting_signals + refuting_signals"
