#!/usr/bin/env bash
# scripts_Exp2/run_abl5_analysis_only.sh
# Ablation 5: BasePack + conflict_summary + risk_note (no claim or signals)
# Run from project root: bash scripts_Exp2/run_abl5_analysis_only.sh
...
ABL_NAME="abl5_analysis_only"
ABL_MODE="analysis_only"
...
echo "  fields     : conflict_summary + risk_note"
