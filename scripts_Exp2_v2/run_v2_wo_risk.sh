#!/usr/bin/env bash
# scripts_Exp2_v2/run_v2_wo_risk.sh
# W/O ablation: remove risk_note (keep claim + supporting + refuting + conflict)
# Run from project root: bash scripts_Exp2_v2/run_v2_wo_risk.sh
...
echo "  removed    : risk_note"
echo "  fields     : claim_summary + supporting + refuting + conflict_summary"
