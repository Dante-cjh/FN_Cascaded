#!/usr/bin/env bash
# scripts_Exp2_v2/run_v2_full.sh
# W/O ablation baseline: full LLM aug (all 5 fields)
# Run from project root: bash scripts_Exp2_v2/run_v2_full.sh
...
echo "  removed    : (none — full 5 fields)"
