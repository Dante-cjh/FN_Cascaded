#!/usr/bin/env bash
# scripts_Exp2_dir2/run_dir2_full.sh
# W/O ablation baseline: full LLM aug (all 7 Dir2 fields)
# Run from project root: bash scripts_Exp2_dir2/run_dir2_full.sh
...
echo "               coordination_signals + evidence_visibility + attention_triggers +"
echo "               manipulation_risk_profile"
