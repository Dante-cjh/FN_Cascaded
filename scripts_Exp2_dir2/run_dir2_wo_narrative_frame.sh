#!/usr/bin/env bash
# scripts_Exp2_dir2/run_dir2_wo_narrative_frame.sh
# W/O ablation: remove narrative_frame
# Run from project root: bash scripts_Exp2_dir2/run_dir2_wo_narrative_frame.sh
...
ABL_MODE="wo_narrative_frame"
ABL_NAME="dir2_wo_narrative_frame"
