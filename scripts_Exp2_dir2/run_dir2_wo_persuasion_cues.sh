#!/usr/bin/env bash
# scripts_Exp2_dir2/run_dir2_wo_persuasion_cues.sh
# W/O ablation: remove persuasion_cues
# Run from project root: bash scripts_Exp2_dir2/run_dir2_wo_persuasion_cues.sh
...
ABL_MODE="wo_persuasion_cues"
ABL_NAME="dir2_wo_persuasion_cues"
