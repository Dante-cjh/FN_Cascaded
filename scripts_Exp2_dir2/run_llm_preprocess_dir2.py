"""
scripts_Exp2_dir2/run_llm_preprocess_dir2.py
Direction 2 (Narrative/Manipulation): LLM preprocessing with propagation-risk fields.

Anchor field for parse validation: narrative_frame
...
Output: outputs/exp2_dir2/llm_aug_{split}.jsonl
...
def main():
    parser = argparse.ArgumentParser(
        description="Dir2 (Narrative/Manipulation): Run LLM preprocessing"
    )
    parser.add_argument("--input_dir",  default="data/processed")
    parser.add_argument("--output_dir", default="outputs/exp2_dir2")
    parser.add_argument("--splits", nargs="+", default=["train", "val", "test"])
    parser.add_argument("--config",  default="configs/api_config.yaml")
    parser.add_argument("--prompt",  default="prompts/llm_preprocess_dir2.txt")
