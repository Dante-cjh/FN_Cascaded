#!/usr/bin/env bash
# scripts_Exp2_dir1/run_dir1_wo_evidence_basis.sh
# W/O ablation: remove evidence_basis
# Run from project root: bash scripts_Exp2_dir1/run_dir1_wo_evidence_basis.sh
...
ABL_MODE="wo_evidence_basis"
ABL_NAME="dir1_wo_evidence_basis"
