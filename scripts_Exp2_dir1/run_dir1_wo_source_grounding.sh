#!/usr/bin/env bash
# scripts_Exp2_dir1/run_dir1_wo_source_grounding.sh
# W/O ablation: remove source_grounding
# Run from project root: bash scripts_Exp2_dir1/run_dir1_wo_source_grounding.sh
...
ABL_MODE="wo_source_grounding"
ABL_NAME="dir1_wo_source_grounding"
