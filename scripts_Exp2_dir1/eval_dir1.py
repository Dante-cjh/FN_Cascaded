"""
scripts_Exp2_dir1/eval_dir1.py
Direction 1 (Verifiability): Evaluate test predictions.

Reads:  outputs/exp2_dir1/test_predictions.jsonl
Writes: outputs/exp2_dir1/metrics/results.{txt,json}

Run from project root:
  python scripts_Exp2_dir1/eval_dir1.py
"""
...
EXP_NAME    = "Dir1 (Verifiability)"
PRED_PATH   = "outputs/exp2_dir1/test_predictions.jsonl"
METRICS_DIR = "outputs/exp2_dir1/metrics"

FIELDS = [
    "claim_core", "claim_components", "evidence_basis",
    "verification_gaps", "source_grounding", "ambiguity_flags", "followup_checks",
]
...
def main():
    ...
    summary = (
        ...
        f"Prompt     : prompts/llm_preprocess_dir1.txt\n"
