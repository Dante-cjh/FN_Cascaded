#!/usr/bin/env bash
# scripts_Exp2_dir1/run_dir1_wo_followup_checks.sh
# W/O ablation: remove followup_checks
# Run from project root: bash scripts_Exp2_dir1/run_dir1_wo_followup_checks.sh
...
ABL_MODE="wo_followup_checks"
ABL_NAME="dir1_wo_followup_checks"
