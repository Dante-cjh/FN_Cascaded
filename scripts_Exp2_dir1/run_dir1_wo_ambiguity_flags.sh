#!/usr/bin/env bash
# scripts_Exp2_dir1/run_dir1_wo_ambiguity_flags.sh
# W/O ablation: remove ambiguity_flags
# Run from project root: bash scripts_Exp2_dir1/run_dir1_wo_ambiguity_flags.sh
...
ABL_MODE="wo_ambiguity_flags"
ABL_NAME="dir1_wo_ambiguity_flags"
