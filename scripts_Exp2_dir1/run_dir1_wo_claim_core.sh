#!/usr/bin/env bash
# scripts_Exp2_dir1/run_dir1_wo_claim_core.sh
# W/O ablation: remove claim_core
# Run from project root: bash scripts_Exp2_dir1/run_dir1_wo_claim_core.sh
...
ABL_MODE="wo_claim_core"
ABL_NAME="dir1_wo_claim_core"
