#!/usr/bin/env bash
# scripts_Exp2_dir1/run_dir1_wo_verification_gaps.sh
# W/O ablation: remove verification_gaps
# Run from project root: bash scripts_Exp2_dir1/run_dir1_wo_verification_gaps.sh
...
ABL_MODE="wo_verification_gaps"
ABL_NAME="dir1_wo_verification_gaps"
...
echo "  removed    : verification_gaps"
