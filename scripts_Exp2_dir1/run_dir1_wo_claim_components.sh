#!/usr/bin/env bash
# scripts_Exp2_dir1/run_dir1_wo_claim_components.sh
# W/O ablation: remove claim_components
# Run from project root: bash scripts_Exp2_dir1/run_dir1_wo_claim_components.sh
...
ABL_MODE="wo_claim_components"
ABL_NAME="dir1_wo_claim_components"
